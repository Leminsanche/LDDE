...
# print(connectivity_total.shape)
#####
...
disp_file  ='Testing/Displacement_Tests/Cube_10x10.npy'
...
# External_energy  =  malla.External_Energy(disp,Neumann_BC=bc_neumann_cells)
